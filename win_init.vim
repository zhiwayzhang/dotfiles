...
" Plug 'https://hub.fastgit.xyz/junegunn/gv.vim.git'
Plug 'https://hub.fastgit.xyz/vim-airline/vim-airline'
Plug 'https://hub.fastgit.xyz/vim-airline/vim-airline-themes'
Plug 'https://hub.fastgit.xyz/jiangmiao/auto-pairs'
Plug 'https://hub.fastgit.xyz/Yggdroot/indentLine'
" Plug 'https://hub.fastgit.xyz/iamcco/markdown-preview.vim', {'do': { -> mkdp#util#install() }, 'for': ['markdown', 'vim-plug']}
Plug 'https://hub.fastgit.xyz/dart-lang/dart-vim-plugin'
Plug 'https://hub.fastgit.xyz/crusoexia/vim-monokai'
Plug 'https://hub.fastgit.xyz/preservim/nerdtree'
Plug 'https://hub.fastgit.xyz/Xuyuanp/nerdtree-git-plugin'
Plug 'https://hub.fastgit.xyz/majutsushi/tagbar'
Plug 'https://hub.fastgit.xyz/mbbill/undotree'
